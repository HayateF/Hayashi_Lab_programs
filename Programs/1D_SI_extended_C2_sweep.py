...
C_1 = 0.0	# DW-motion-to-DMI conversion coefficient
C_2 = 0.0
...
C_i_start = -18	# C_2 starts from 1e-10
C_i_end = -14	# C_2 ends at 1e-15
C_i_split = 100
...
plt.xlabel("Conversion Coefficient [mJ/m$^2$ / (A/m$^2$)]")
plt.ylabel("Velocity [m/s]")
plt.legend()
plt.grid(True)

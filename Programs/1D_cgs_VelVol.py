...
for J in Current:
	...
	## solve the equation
	y_1 = odeint(one_dim_model_3var, y_0, t_1, args = (Alpha, Gamma, Delta, Width, DWtype, H_K(T_FM, M_s, Delta), H_DM(D(J), DWtype, Delta, M_s), H_SH(Theta_SH, J, M_s, T_FM), K_eff, M_s))
	
	y_0 = y_1[-1]	# the initial condition is the final state of the previous calculation.
	y_2 = odeint(one_dim_model_3var, y_0, t_2, args = (Alpha, Gamma, Delta, Width, DWtype, H_K(T_FM, M_s, Delta), H_DM(D(0), DWtype, Delta, M_s), H_SH(Theta_SH, 0, M_s, T_FM), K_eff, M_s))

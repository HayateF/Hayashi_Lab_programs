...
# perform fitting
fit [-600:600] [1:*] vpu(x) "< tail -n +2 velocity+current.txt" u 5:($12 * f) via Apu, Bpu
fit [-600:600] [1:*] vpd(x) "< tail -n +2 velocity+current.txt" u 5:($15 * f) via Apd, Bpd
fit [-350:600] [*:-1] vnu(x) "< tail -n +2 velocity-current.txt" u 5:($12 * f) via Anu, Bnu
fit [-600:450] [*:-1] vnd(x) "< tail -n +2 velocity-current.txt" u 5:($15 * f) via And, Bnd

...
# perform fitting
fit [-150:600] [1:*] vpu(x) "< tail -n +2 velocity+current.txt" u 5:($12 * f) via Apu, Bpu
fit [-600:150] [1:*] vpd(x) "< tail -n +2 velocity+current.txt" u 5:($15 * f) via Apd, Bpd
fit [-450:600] [*:-1] vnu(x) "< tail -n +2 velocity-current.txt" u 5:($12 * f) via Anu, Bnu

...
# perform fitting
fit [-550:1100] [1:*] vpu(x) "< tail -n +2 up-down_Hx/velocity_up-down_+current.txt" u ($3 * Hall_a + Hall_b):($12 * f) via Apu, Bpu
fit [-1100:550] [1:*] vpd(x) "< tail -n +2 down-up_Hx/velocity_down-up_+current.txt" u ($3 * Hall_a + Hall_b):($15 * f) via Apd, Bpd
